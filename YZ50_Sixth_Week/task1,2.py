...
# read in all the words (names.txt lives in the Fourth_Week folder)
names_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'YZ50_Fourth_Week', 'names.txt')
